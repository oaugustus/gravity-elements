(function (global, factory) {
	...
	function l(e, t = (e) => e) {
		...
		r(e, "focus", () => r(window, "wheel", n, { passive: false })), r(e, "blur", () => i(window, "wheel", n));
	}
	//#endregion
	...
	function E(e) {
		let t = {
			...
			destroy() {
				...
				i(document, ["keydown", "keyup"], r), i([e.wrapper, e.element], "mousedown", n), i([e.wrapper, e.element], "touchstart", n, { passive: false });
			}
		}, { options: n, _tapstart: a, _keyboard: o } = t;
		return r([n.wrapper, n.element], "mousedown", a), r([n.wrapper, n.element], "touchstart", a, { passive: false }), r(document, ["keydown", "keyup"], o), t;
	}
	//#endregion
    ...
    `), d = u.interaction;
		...
		constructor(t) {
			...
			this._setupAnimationFrame = requestAnimationFrame((function e() {
				...
				m.setColor(t.default), m._rePositioningPicker(), t.defaultRepresentation && (m._representation = t.defaultRepresentation, m.setColorRepresentation(m._representation)), t.showAlways && m.show(), m._initializingActive = false, m._emit("init");
			}));
		}
		...
		_bindEvents() {
			let { _root: e, options: t } = this, n = [
				...
				r(e.interaction.result, ["keyup", "input"], (e) => {
					this.setColor(e.target.value, true) && !this._initializingActive && (this._emit("change", this._color, "input", this), this._emit("changestop", "input", this)), e.stopImmediatePropagation();
				}),
		...
		addSwatch(e) {
			...
			if (t) {
				...
				return n.swatches.appendChild(o), e.push({
					...
					this.setHSVA(...i.toHSVA(), true), this._emit("swatchselect", i), this._emit("change", i, "swatch", this);
				})), true;
			}
			return false;
		}
		removeSwatch(e) {
			...
			if (t) {
				let { el: n } = t;
				return this._root.swatches.removeChild(n), this._swatchColors.splice(e, 1), true;
			}
			return false;
		}
		applyColor(e = false) {
		...
		hide() {
			return this.isOpen() ? (this._root.app.classList.remove("visible"), this._emit("hide"), true) : false;
		}
		show() {
			return !this.options.disabled && !this.isOpen() ? (this._root.app.classList.add("visible"), this._rePositioningPicker(), this._emit("show", this._color), this) : false;
		}
		isOpen() {
			return this._root.app.classList.contains("visible");
		}
		setHSVA(e = 360, t = 0, n = 0, r = 1, i = false) {
			let a = this._recalc;
			if (this._recalc = false, e < 0 || e > 360 || t < 0 || t > 100 || n < 0 || n > 100 || r < 0 || r > 1) return false;
			this._color = w(e, t, n, r);
			let { hue: o, opacity: s, palette: c } = this._components;
			return o.update(e / 360), s.update(r), c.update(t / 100, 1 - n / 100), i || this.applyColor(), a && this._updateOutput(), this._recalc = a, true;
		}
		setColor(e, t = false) {
			if (e === null) return this._clearColor(t), true;
			...
			if (n) {
				...
				return this.setHSVA(...n, t) ? this.setColorRepresentation(e) : false;
			}
			return false;
		}
